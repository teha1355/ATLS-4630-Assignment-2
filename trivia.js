...
const roundTwo = document.getElementById('round-two'); //spelling error
...
function startRoundTwo(event) {
  ...
  for (let i = 0; i < roundTwoQuestions.length; i++) { //change .size to .length
